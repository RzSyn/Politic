...
word_output_path = get_writable_path(os.path.join(wd, "รัฐธรรมนูญ_๒๕๒๕_แก้ไขเพิ่มเติม.docx"))
toc_output_path = get_writable_path(os.path.join(wd, "สารบัญรัฐธรรมนูญ.docx"))
