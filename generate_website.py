  ...
  <div class="dashboard-card">
      ...
      <div class="rama7-profile" style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap; text-align: left;">
        ...
        <div style="flex: 0.9; min-width: 300px; background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(212, 175, 55, 0.15); border-radius: 12px; padding: 20px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="king_r7.jpg" alt="พระประชาธิปมหาราช" style="width: 540px; border-radius: 12px; border: 3px solid var(--gold); box-shadow: 0 8px 24px rgba(0,0,0,0.6);">
          </div>
    ...
    <div id="rama9-tab" class="db-tab-content">
      <div class="rama9-profile" style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap; text-align: left;">
        ...
        <div style="flex: 0.9; min-width: 300px; background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(212, 175, 55, 0.15); border-radius: 12px; padding: 20px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="king_r9.webp" alt="พระมหาภูมิพลมหาราช" style="width: 540px; border-radius: 12px; border: 3px solid var(--gold); box-shadow: 0 8px 24px rgba(0,0,0,0.6);">
          </div>
      ...
      <div class="accordion" style="text-align: left; margin-bottom: 24px;">
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 450px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r7.jpg" alt="พระบาทสมเด็จพระปกเกล้าเจ้าอยู่หัว" style="width: 450px; border-radius: 8px; border: 2px solid rgba(255, 255, 255, 0.15); box-shadow: 0 6px 15px rgba(0,0,0,0.5);">
                </div>
                <div style="flex: 1; min-width: 250px;">
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 450px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r9.webp" alt="พระบาทสมเด็จพระบรมชนกาธิเบศร มหาภูมิพลอดุลยเดชมหาราช บรมนาถบพิตร" style="width: 450px; border-radius: 8px; border: 2px solid rgba(255, 255, 255, 0.15); box-shadow: 0 6px 15px rgba(0,0,0,0.5);">
                </div>
                <div style="flex: 1; min-width: 250px;">
