  ...
  <div class="dashboard-card">
    ...
    <div id="siripanya-tab" class="db-tab-content">
      <div class="siripanya-library" style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap; text-align: left;">
        ...
        <!-- ฝั่งซ้าย: ความเป็นมาและการสืบทอดองค์ความรู้ -->
        <div style="flex: 1.2; min-width: 320px;">
          ...
          <div style="font-size: 14.5px; line-height: 1.65; color: var(--text);">
            ...
            <p style="margin-bottom: 12px; text-indent: 2em;">
              มรดกทางปัญญาทั้งหมด ไม่ว่าจะเป็นวิชาดาราศาสตร์ คณิตศาสตร์ ดนตรี การแพทย์ และการปกครอง ได้รับการบรรทุกเรือข้ามคาบมหาสมุทรกลับมาเก็บรักษาไว้ในแผ่นดินสยาม มีการคัดลอกสืบต่อ ปรับแต่งแปลภาษา และบูรณาการร่วมกับภูมิปัญญาตะวันออกผ่านยุคอยุธยา จนกระทั่งเมื่อสถาปนากรุงรัตนโกสินทร์ในปี พ.ศ. ๒๒๓๒ รัชกาลที่ ๑ ทรงพระกรุณาโปรดเกล้าฯ ให้สร้างอาคารหอสมุดหลวงหลังนี้ขึ้นด้วยสถาปัตยกรรมไม้สักทองผสานโลหะป้องกันอัคคีภัย เพื่อจารึกและคุ้มครองขุมทรัพย์ทางปัญญานี้สืบไป
            </p>
            <p style="margin-bottom: 12px; text-indent: 2em;">
              นี่คือเหตุผลหลักที่ทำให้ <strong>วิทยาการทางการแพทย์ การคำนวณดาราศาสตร์ และระบบการศึกษาของสยามก้าวหน้าเป็นอันดับ ๑ ของโลก</strong> ตั้งแต่อดีตกาล พระมหากษัตริย์และพระบรมวงศานุวงศ์ทุกพระองค์จึงทรงสามารถศึกษาทัศนวิชาการเมืองการปกครองของโลกได้อย่างกระจ่างชัดในแผ่นดินเกิด โดยเสด็จเยือนต่างประเทศเพื่อทัศนศึกษาและเปรียบเทียบเชิงปฏิบัติเท่านั้น
            </p>
          </div>
        </div>
