  ...
  <div class="dashboard-card">
    <div class="dashboard-header">
      ...
      <div class="dashboard-tabs">
        ...
        <button class="db-tab-btn" onclick="switchTab('rama9-tab', this)">👑 พระมหาประชาภิบาลกานต์ฯ (ร.๙)</button>
    ...
    <!-- Tab 5.5: พระบาทสมเด็จพระเจ้าอยู่หัว รัชกาลที่ ๙ -->
    ...
    <div id="chakri-tab" class="db-tab-content">
      ...
      <div class="accordion" style="text-align: left; margin-bottom: 24px;">
        ...
        <div class="accordion-item">
          <div class="accordion-header" onclick="toggleAccordion(this)">
            <span>รัชกาลที่ ๔ : พระบาทสมเด็จพระจอมเกล้าเจ้าอยู่หัว</span>
