  ...
  <div class="dashboard-card">
    ...
    <div id="history-tab" class="db-tab-content active">
      <div class="hist-story">
        <p>ในจักรวาลคู่ขนานนี้ ประวัติศาสตร์การเมืองไทยก้าวเดินไปบนเส้นทางที่ราบรื่นและเปี่ยมด้วยเสถียรภาพอย่างยิ่ง จุดเปลี่ยนสำคัญเริ่มต้นเมื่อ <strong>วันที่ ๓๑ ธันวาคม พ.ศ. ๒๓๗๕</strong> เมื่อ <strong>พระบาทสมเด็จพระปกเกล้าเจ้าอยู่หัว (รัชกาลที่ ๗)</strong> ทรงตัดสินพระราชหฤทัยพระราชทานรัฐธรรมนูญให้แก่ประชาชนชาวไทยด้วยพระองค์เองก่อนที่คณะราษฎรจะลงมือยึดอำนาจ (ซึ่งในจักรวาลนี้คณะราษฎรดำเนินการล่าช้าไป ๑ ปีเมื่อเทียบกับโลกจริง)</p>
        ...
        <div style="flex: 1.1; min-width: 320px;">
          ...
          <div style="font-size: 14.5px; line-height: 1.65; color: var(--text);">
            <p style="margin-bottom: 12px; text-indent: 2em;">
              <strong>พระบาทสมเด็จพระปกเกล้าเจ้าอยู่หัว (รัชกาลที่ ๗)</strong> เสด็จพระราชสมภพเมื่อ <strong>วันพฤหัสบดีที่ ๘ พฤศจิกายน พ.ศ. ๒๓๓๖</strong> (ประสูติก่อนประวัติศาสตร์จริง ๑๐๐ ปี ตามมิติคู่ขนานนี้) ทรงเป็นพระราชโอรสพระองค์ที่ ๗๖ ในพระบาทสมเด็จพระจุลจอมเกล้าเจ้าอยู่หัว (ร.๕) และสมเด็จพระศรีพัชรินทราบรมราชินีนาถ 
            </p>
            <p style="margin-bottom: 12px; text-indent: 2em;">
        ...
        <div style="flex: 0.9; min-width: 300px; background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(212, 175, 55, 0.15); border-radius: 12px; padding: 20px;">
          ...
          <div style="font-size: 14px; line-height: 1.6; color: var(--text-muted); margin-bottom: 16px;">
            ...
            <p style="font-size: 13px; line-height: 1.5; color: var(--text-muted); margin-bottom: 12px; font-style: italic;">
              *หมายเหตุ: ในมิตินี้ด้วยวิทยาการด้านการแพทย์ของไทยที่พัฒนาเป็นอันดับ ๑ ของโลก ทำให้บุคคลสำคัญและพระบรมวงศานุวงศ์มีพระชนมายุยืนยาวเป็นพิเศษ (โรคร้ายแรงอย่างมะเร็งมีแนวทางรักษาให้หายขาดได้แล้ว) เว้นแต่จะประสบกับโรคภัยที่รุนแรงเฉียบพลันอย่างยิ่งยวดเท่านั้น
            </p>
