    ...
    <div id="geopolitics-tab" class="db-tab-content">
      ...
      <div class="geo-container">
        <div class="geo-header">
          ...
          <p style="color: var(--text-muted); font-size: 14.5px; margin-bottom: 0;">ระเบียบโลกใหม่ในลักษณะ "ราชจักรวรรดิ" (Royal Empire) ที่บริหารโดย "ปธานาทิปดี" (President) เป็นผู้มีอำนาจสูงสุดของแผ่นดิน และ "จักรพรรดิ" (Emperor) ทรงอยู่ภายใต้รัฐธรรมนูญจำลองสูงสุดอย่างเคร่งครัด</p>
        </div>
        ...
        <div class="goc-section" style="border-bottom: none; padding-bottom: 0; margin-bottom: 16px;">
          ...
          <div class="geo-grid">
            <div class="geo-card">
              <div class="geo-card-title">👑 ระบอบราชจักรวรรดิ & ปธานาทิปดี</div>
              <div class="geo-card-desc">ระบอบการปกครองหลักในระเบียบภูมิรัฐศาสตร์โลกใหม่ที่ผสานระบอบสถาบันดั้งเดิมเข้ากับระบอบสาธารณรัฐจำลองในรูปแบบ <strong>"ราชจักรวรรดิ" (Royal Empire)</strong> โดยสถาปนาตำแหน่ง <strong>"ปธานาทิปดี" (President)</strong> เป็นผู้มีอำนาจบริหารแผ่นดินสูงสุดและยิ่งใหญ่ที่สุด ขณะที่องค์ <strong>"จักรพรรดิ" (Emperor)</strong> ทรงดำรงอยู่ภายใต้รัฐธรรมนูญและกฎหมายสูงสุดของรัฐสภาอย่างเคร่งครัด</div>
            </div>
            <div class="geo-card">
