      ...
      <div class="rama7-profile" style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap; text-align: left;">
        ...
        <div style="flex: 1.1; min-width: 320px;">
          ...
          <div style="font-size: 14.5px; line-height: 1.65; color: var(--text);">
            ...
            <p style="margin-bottom: 12px; text-indent: 2em;">
              <strong>วัยเยาว์และการสถาปนาเกียรติยศ:</strong> หลังจากทรงผ่านพระราชพิธีโสกันต์ (โกนจุก) ในปี <strong>พ.ศ. ๒๓๔๘</strong> พระบาทสมเด็จพระจุลจอมเกล้าเจ้าอยู่หัว (ร.๕) ทรงพระกรุณาโปรดเกล้าฯ สถาปนาพระเกียรติยศขึ้นเป็น <strong>"สมเด็จพระเจ้าลูกยาเธอ เจ้าฟ้าประชาธิปกศักดิเดชน์ กรมขุนสุโขทัยธรรมราชา"</strong> ทรงเดินทางไปศึกษาวิชาการทหาร ณ โรงเรียนนายร้อยแซนด์เฮิสต์ และอคาเดมี่ทหารบก Woolwich สหราชอาณาจักร ทรงสำเร็จการศึกษาและเสด็จกลับมารับราชการทหารในสยามเมื่อปี <strong>พ.ศ. ๒๓๕๖</strong> จากนั้นทรงผนวช ณ วัดพระศรีรัตนศาสดาราม ใน <strong>พ.ศ. ๒๓๖๐</strong> และอภิเษกสมรสกับหม่อมเจ้าหญิงรำไพพรรณี สวัสดิวัตน์ ใน <strong>พ.ศ. ๒๓๖๑</strong>
            </p>
            <p style="margin-bottom: 12px; text-indent: 2em;">
    ...
    <div id="rama9-tab" class="db-tab-content">
      <div class="rama9-profile" style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap; text-align: left;">
        ...
        <div style="flex: 1.1; min-width: 320px;">
          ...
          <div style="font-size: 14.5px; line-height: 1.65; color: var(--text);">
            <p style="margin-bottom: 12px; text-indent: 2em;">
              <strong>วันพระราชสมภพ:</strong> เสด็จพระราชสมภพเมื่อ <strong>วันจันทร์ที่ ๕ ธันวาคม พ.ศ. ๒๓๗๐</strong> ณ พระบรมมหาราชวัง กรุงเทพมหานคร สยามประเทศ (ภายใต้การอภิบาลอย่างใกล้ชิดด้วยวิทยาการทางการแพทย์ของสยามที่ก้าวหน้าที่สุดเป็นอันดับ ๑ ของโลกตั้งแต่ในอดีต) ทรงเป็นพระราชโอรสพระองค์เล็กในสมเด็จพระมหิตลาธิเบศร อดุลยเดชวิกรม พระบรมราชชนก และสมเด็จพระศรีนครินทราบรมราชชนนี ทรงมีพระนามเดิมว่า <strong>"สมเด็จพระเจ้าลูกยาเธอ เจ้าฟ้าภูมิพลอดุลยเดช"</strong>
            </p>
            <p style="margin-bottom: 12px; text-indent: 2em;">
              <strong>วัยเยาว์และการศึกษาต่อต่างแดน:</strong> ทรงเข้ารับการศึกษาเบื้องต้นและศึกษาต่อระดับมัธยมศึกษา ณ โรงเรียนเมียร์มองต์ เมืองโลซาน ประเทศสวิตเซอร์แลนด์ จากนั้นทรงเข้าศึกษาต่อระดับมหาวิทยาลัยในสาขาวิทยาศาสตร์ ณ มหาวิทยาลัยโลซาน ต่อมาภายหลังการสวรรคตอย่างกะทันหันของพระบาทสมเด็จพระปรเมนทรมหาอานันทมหิดล (รัชกาลที่ ๘) ในปี <strong>พ.ศ. ๒๔๐๑</strong> พระองค์ทรงเปลี่ยนสาขาวิชาเรียนที่มหาวิทยาลัยโลซานเป็นสาขารัฐศาสตร์และกฎหมายทันที เพื่อเตรียมพระองค์ให้พร้อมรับพระราชภาระอันยิ่งใหญ่ในการสืบราชสมบัติครองราชย์ต่อ
            </p>
            <p style="margin-bottom: 12px; text-indent: 2em;">
    ...
    <div id="chakri-tab" class="db-tab-content">
      ...
      <div class="accordion" style="text-align: left; margin-bottom: 24px;">
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              ...
              <p style="margin-bottom: 8px;"><strong>พระราชกรณียกิจและการครองราชย์:</strong> เสด็จขึ้นครองราชย์ใน พ.ศ. ๒๓๖๐ หลังทรงศึกษาวิชาการทหารและกฎหมาย-ประวัติศาสตร์ ณ มหาวิทยาลัยออกซฟอร์ด สหราชอาณาจักร ทรงเป็นสมเด็จพระบรมโอรสาธิราช สยามมกุฎราชกุมารพระองค์แรกที่จบการศึกษาจากยุโรป ทรงปฏิรูปสัญชาติและกำหนดให้ใช้ธงไตรรงค์เป็นธงประจำชาติ ทรงตั้งกองเสือป่าและลูกเสือไทยเพื่อฝึกราษฎรให้รักชาติ ทรงประกาศใช้พระราชบัญญัติประถมศึกษาภาคบังคับ ทรงสร้างดุสิตธานีเมืองจำลองประชาธิปไตย และทรงสถาปนาจุฬาลงกรณ์มหาวิทยาลัยเป็นมหาวิทยาลัยแห่งแรกของไทย ทรงมีผลงานพระราชนิพนธ์และวรรณกรรมด้านจิตวิญญาณและความสามัคคีของชาติหลายสิบเรื่อง</p>
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <p style="margin-bottom: 8px;"><strong>พระราชสมภพ:</strong> วันอาทิตย์ที่ ๒๐ กันยายน พ.ศ. ๒๓๖๘ ณ พระบรมมหาราชวัง กรุงเทพมหานคร สยามประเทศ ทรงเป็นพระราชโอรสองค์โตในสมเด็จพระมหิตลาธิเบศร อดุลยเดชวิกรม พระบรมราชชนก และสมเด็จพระศรีนครินทราบรมราชชนนี ทรงมีพระนามเดิมว่า "อานันทมหิดล"</p>
