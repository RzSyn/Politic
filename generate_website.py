  ...
  <div class="dashboard-card">
    ...
    <div id="history-tab" class="db-tab-content active">
      <div class="hist-story">
        ...
        <p>การพระราชทานรัฐธรรมนูญล่วงหน้านี้ส่งผลให้คณะทหารแกนนำกลุ่ม <strong>"๔ ทหารเสือ"</strong> (พระยาพหลพลพยุหเสนา, พระยาทรงสุรเดช, พระยาฤทธิอัคเนย์ และพระประศาสน์พิทยายุทธ) มองเห็นว่าไม่มีความจำเป็นอันใดที่จะต้องทำรัฐประหารหรือยึดอำนาจอีกต่อไป จึงถอนตัวและไม่เข้าร่วมเคลื่อนไหวกับคณะราษฎร คงเหลือเพียงฝ่ายพลเรือนนำโดย <strong>ปรีดี พนมยงค์</strong> ที่ยังคงเคลื่อนไหวต่อ แม้ในเวลาต่อมาปรีดีจะได้ทำการลอบปลงพระชนม์ รัชกาลที่ ๘ แต่กระทำการสำเร็จเพียงช่วงสั้นๆ และไม่สามารถสั่นคลอนสถาบันพระมหากษัตริย์ได้ รัชกาลที่ ๗ สวรรคตอย่างสมพระเกียรติและได้รับการถวายพระราชสมัญญา <strong>"มหาราช"</strong></p>
...
<section class="hero" style="padding: 40px 20px; text-align: center;">
  <div class="hero-content">
    ...
    <p class="subtitle" style="font-size: 15px; color: var(--text-muted); margin-bottom: 20px;">ฉบับประชาชน พ.ศ. ๒๕๒๕ — สรุปเนื้อหาสำคัญเข้าใจง่ายของมาตรา ๑ ถึง ๑,๑๕๘</p>
  </div>
</section>
