...
pms = [
    ...
    {"num": 22, "name": "รักชนก ศรีนอก", "years": "2614-ปัจจุบัน", "era": "รัฐธรรมนูญฉบับ พ.ศ. ๒๕๒๕", "era_class": "era-3", "note": "นายกหญิงคนที่ 2 ของไทย พรรคก้าวไกลชนะ Landslide 53% การจัดโครงสร้างสภาที่เป็นสภาแบบสิ่งก่อสร้างแล้วก็จัดอำนาจนิติบัญญัติให้กลับมาปกติเหมือนเดิมหลังนายกฯ วิสุทธิ์ คมณรัตน์ ทำเละ\n\nผลงานที่ดำเนินการอยู่:\nหนึ่ง — ปิดช่องโหว่รัฐธรรมนูญที่วิสุทธิ์ใช้ทำนิติประหารสภา — เสนอแก้ไขให้ชัดเจนขึ้นว่าการ \"แก้ไข\" หมวดสำคัญต้องใช้เสียงเท่ากับการ \"ยกเลิก\" ครับ\nสอง — สอบสวน สส. ที่ย้ายพรรค — DSI และ กกต. ดำเนินคดีอย่างเข้มงวด มีผู้ถูกตัดสิทธิ์ทางการเมืองแล้ว 31 คนครับ\nสาม — GOC Reform — หลังวิกฤต รักชนกสั่งทบทวนบทบาท GOC ให้ชัดเจนขึ้น และเพิ่มการตรวจสอบจากภายนอกครับ\nสี่ — ความสัมพันธ์ลาว — สานต่อนโยบายพริษฐ์ เดินหน้าคลองไทยไมตรี 2.0 และรถไฟฟ้าลาว-ไทยครับ"}
]
...
def get_article_comparison(art_num):
    comparisons = {
        ...
        295: (
            ...
            "มาตรา ๓๑๓ (๑) ญัตติขอแก้ไขเพิ่มเติมต้องมาจากคณะรัฐมนตรี หรือจาก ส.ส. ไม่น้อยกว่า ๑/๕ หรือจาก ส.ส. และ ส.ว. รวมกันไม่น้อยกว่า ๑/๕ ของทั้งสองสภา <ins>หรือจากประชาชนผู้มีสิทธิเลือกตั้งจำนวนไม่น้อยกว่าห้าหมื่นคนร่วมกันเข้าชื่อเสนอ</ins>..."
        )
    }
...
dashboard_html = f'''<section id="history_and_pms" class="chapter-section">
  <div class="dashboard-card">
        ...
        <table class="styled-table">
          ...
          <tbody>
            <tr>
              ...
              <td>พระราชทานโดยพระบาทสมเด็จพระปกเกล้าเจ้าอยู่หัว (ร.๗) แบ่งสัดส่วนอำนาจให้พระมหากษัตริย์ร้อยละ ๖๐ และราษฎรร้อยละ ๔๐ เน้นการเริ่มกระจายอำนาจและการเลือกตั้งระดับท้องถิ่น และกำหนดระยะเวลาเตรียมความพร้อมของแผ่นดิน ๔๖ ปี</td>
            </tr>
            <tr>
    ...
    <div id="pms-tab" class="db-tab-content">
      <p style="margin-bottom: 16px; font-size: 15px; color: var(--text-muted);">
        ทำเนียบนายกรัฐมนตรีทั้ง ๑๙ คนของประเทศไทย ทุกท่านมาจากการเลือกตั้งตามครรลองประชาธิปไตย (ไม่มีรัฐประหาร):
      </p>
