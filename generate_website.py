      ...
      <div style="margin-top: 24px; background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(212, 175, 55, 0.15); border-radius: 12px; padding: 24px; text-align: left;">
        ...
        <div style="font-size: 14px; line-height: 1.65; color: var(--text); margin-bottom: 16px;">
          <p style="text-indent: 2em; margin-bottom: 12px;">
            โปรเจกต์เพลงชาติไทยเวอร์ชันแกรมมี่เกิดขึ้นจากการที่ <strong>กระทรวงกลาโหมและรัฐบาลพลเรือน ในสมัยของนายกรัฐมนตรี พิธา ลิ้มเจริญรัตน์ (นายกฯ คนที่ ๑๗)</strong> ได้มอบหมายให้บริษัท <strong>จีเอ็มเอ็ม แกรมมี่ (GMM Grammy)</strong> เป็นผู้สร้างสรรค์และเรียบเรียงทำนองเพลงชาติไทยขึ้นใหม่รวมทั้งสิ้น ๖ รูปแบบ (๖ เวอร์ชัน) ภายหลังการรื้อฟื้นและไขคดีประวัติศาสตร์การลอบปลงพระชนม์ ร.๘ สำเร็จเสร็จสิ้น เพื่อประกาศยืนยันความจงรักภักดีของพรรคก้าวไกลและรัฐบาลพลเรือนว่ายืนเคียงข้างสถาบันพระมหากษัตริย์ และส่งสัญญาณว่าถึงเวลาที่ชาติเราต้องเริ่มการเปลี่ยนแปลงสู่สิ่งใหม่ที่ดีกว่าแล้ว
          </p>
          <p style="text-indent: 2em; margin-bottom: 12px;">
