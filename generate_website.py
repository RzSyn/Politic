...
pms = [
    ...
    {"num": 5, "name": "สัญญา ธรรมศักดิ์", "years": "2453-2461", "era": "รัฐธรรมนูญฉบับ พ.ศ. ๒๔๔๕", "era_class": "era-2", "note": "เนติบัณฑิตและนักกฎหมายผู้ทรงเกียรติยศสูงสุด ดำรงตำแหน่งนายกรัฐมนตรีคนที่ ๕ ท่านผลักดันการปฏิรูปกระบวนการยุติธรรมของชาติอย่างสมบูรณ์แบบ วางระบบป้องกันการแทรกแซงข้าราชการตุลาการ และสร้างหลักความเป็นอิสระของอำนาจศาลจากฝ่ายบริหาร"},
    ...
    {"num": 20, "name": "พริษฐ์ \"ไอติม\" วัชรสินธุ", "years": "2596-2612", "era": "รัฐธรรมนูญฉบับ พ.ศ. ๒๕๒๕", "era_class": "era-3", "note": "นายกรัฐมนตรีคนที่ ๒๐ ผู้นำสายคนรุ่นใหม่ผู้ผ่านพ้นวิกฤตนิติประหารสภาด้วยการอภิปรายชี้แจงรัฐสภานาน ๑๐ วัน และผลักดันโครงการสร้างคลองไทยไมตรี ๒.๐ ในช่วงเวลาต่อมา ในสมัยรัฐบาลของวิสุทธิ์ คมณรัตน์ พริษฐ์ยังได้ทำหน้าที่เป็นผู้นำและผู้บัญชาการหลักของ \"ปฏิบัติการรุ่งอรุณ ๒๒๐\" (Operation Dawn 220) ซึ่งสืบสวนและเปิดโปงเครือข่ายทุนต่างชาติจนสามารถทำให้วิสุทธิ์ คมณรัตน์ พ้นจากอำนาจที่เกิดจากวิกฤตนิติประหารสภาแผ่นดินลงได้สำเร็จอย่างสงบและสง่างาม"},
    {"num": 21, "name": "วิสุทธิ์ คมณรัตน์", "years": "2612-2614", "era": "รัฐธรรมนูญฉบับ พ.ศ. ๒๕๒๕", "era_class": "era-3", "note": "วิสุทธิ์ คมณรัตน์ เป็นผู้อยู่เบื้องหลังการก่อตั้งพรรคประชาปฏิวัติ โดยสร้างนวัตกรรมทางการเมืองด้วยการออกแบบโครงสร้างพรรคแบบไร้จุดศูนย์กลางที่ไม่มีหัวหน้าพรรคเดี่ยว เพื่อส่งเสริมความเท่าเทียมและกระจายอำนาจให้ทุกคนเป็นทั้งหัวหน้าและโฆษก พร้อมทั้งผลักดันกระแสสังคมด้วยนโยบายปฏิรูปกระทรวงและเพิ่มการมีส่วนร่วมของประชาชนโดยตรง เช่น การให้ท้องถิ่นจัดการงบประมาณเองและการโหวตหลักสูตรการศึกษา ซึ่งได้รับความนิยมจากกลุ่มคนรุ่นใหม่อย่างมาก\\n\\nอย่างไรก็ตาม ในด้านข้อเสียและการกระทำที่สร้างปัญหา วิสุทธิ์ถูกวิพากษ์วิจารณ์ว่าใช้นโยบายหาเสียงที่ลอกเลียนแบบพรรคก้าวไกลและอดีตนายกรัฐมนตรีมาถึง 80% เพื่อนำมาเป็นฉากหน้าในการปกปิดวาระซ่อนเร้นที่ต้องการลดอำนาจรัฐส่วนกลางและนำสถาบันพระมหากษัตริย์ออกจากการปกครอง นอกจากนี้เขายังใช้วิธีการแทรกแซงระบบสภาด้วยการรับเงินทุนจากต่างประเทศมาใช้กว้านซื้อ สส. ย้ายพรรค และพยายามใช้อำนาจนิติบัญญัติบิดเบือนเจตนารมณ์ของรัฐธรรมนูญ\\n\\nจนในที่สุด เมื่อศาลรัฐธรรมนูญมีมติเป็นเอกฉันท์ 6 ต่อ 0 ว่าการกระทำดังกล่าวขัดต่อรัฐธรรมนูญและสั่งยุติตำแหน่ง เขาก็ยอมรับกระบวนการทางกฎหมายด้วยการเดินออกจากสภาอย่างสงบ และลงนามในจดหมายลาออกด้วยตัวเองโดยไม่ปลุกระดมสร้างความวุ่นวาย ปิดฉากบทบาททางการเมืองของเขาลง"},
...
for pm in pms:
  ...
  <td style="text-align: center; vertical-align: middle;">
    <div style="width: 70px; height: 85px; border: 1.5px solid var(--gold); border-radius: 4px; overflow: hidden; background: #000; box-shadow: 0 4px 8px rgba(0,0,0,0.5); margin: 0 auto; display: flex; align-items: center; justify-content: center;">
      <img src="{img_filename}" alt="{name_str}" style="width: 100%; height: 100%; object-fit: cover;">
    </div>
  </td>
  <td><span style="color: var(--gold-light); font-size: 14.5px;">{name_display}</span></td>
  <td>{years_str}</td>
  <td><span class="era-badge {era_class}">{era_str}</span></td>
  <td style="font-size: 13.5px; line-height: 1.5; color: var(--text-muted);">{note_str}</td>
</tr>''')
pm_table_rows_html = '\n'.join(pm_rows)
