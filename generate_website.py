    ...
    <div id="figures-tab" class="db-tab-content">
      ...
      <div class="tri-container">
        ...
        <div class="tri-layout" style="margin-bottom: 32px;">
          <div class="tri-profile-card">
            ...
            <div class="tri-meta">
              ...
              <div style="margin-bottom: 6px;"><strong>ตำแหน่งสำคัญ:</strong> นายกรัฐมนตรีคนแรก (พ.ศ. ๒๔๒๑)</div>
              <div style="margin-bottom: 6px;"><strong>ผู้ดูแลระบบ:</strong> "บันไดประชาธิปไตย" กระจายอำนาจ ๔๖ ปี</div>
              <div><strong>ความเชื่อมโยง:</strong> ได้รับความไว้วางใจสูงสุดจาก ร.๗</div>
            </div>
          </div>

          <div class="tri-bio">
            <div class="tri-stage">
              <div class="tri-stage-title">⚖️ ผู้ทรงคุณวุฒิและผู้วางรากฐานประชาธิปไตยสากล</div>
              <p class="tri-stage-text">ในไทม์ไลน์นี้ พระยามโนปกรณ์นิติธาดาเป็นนักกฎหมายผู้ทรงคุณวุฒิที่ได้รับความไว้วางใจจากพระบาทสมเด็จพระปกเกล้าเจ้าอยู่หัว (ร.๗) ให้เข้ามามีบทบาทสำคัญตั้งแต่ช่วงแรกของการวางรากฐานประชาธิปไตย หลังการพระราชทานรัฐธรรมนูญฉบับปฐมเวลาในปี ๒๓๗๕ ท่านได้รับมอบหมายให้ดูแลกระบวนการ "บันไดประชาธิปไตย" ที่ค่อยๆ กระจายอำนาจจากส่วนกลางสู่ท้องถิ่นตามกรอบเวลา ๔๖ ปีที่วางไว้ในรัฐธรรมนูญ</p>
            </div>

            <div class="tri-stage">
              <div class="tri-stage-title">🗳️ นายกรัฐมนตรีคนแรกจากการเลือกตั้งครั้งประวัติศาสตร์ พ.ศ. ๒๔๒๑</div>
              <p class="tri-stage-text">ด้วยความเชี่ยวชาญด้านกฎหมายและความไว้เนื้อเชื่อใจจากทั้งฝ่ายราชสำนักและฝ่ายราษฎร ท่านได้รับเลือกเป็นนายกรัฐมนตรีคนแรกของประเทศไทยที่มาจากการเลือกตั้งในปี ๒๔๒๑ อันเป็นปีที่กระบวนการเตรียมความพร้อม ๔๖ ปีตามรัฐธรรมนูญฉบับปฐมเวลาเสร็จสมบูรณ์ ถือเป็นหมุดหมายสำคัญที่แสดงให้เห็นว่าการเปลี่ยนผ่านอำนาจจากสถาบันพระมหากษัตริย์สู่ประชาชนเป็นไปอย่างราบรื่นตามที่ ร.๗ ทรงตั้งพระทัยไว้</p>
            </div>

            <div class="tri-stage">
              <div class="tri-stage-title">🏛️ บรรทัดฐานการบริหารและความรับผิดชอบต่อรัฐสภา</div>
              <p class="tri-stage-text">ในฐานะนายกรัฐมนตรีคนแรก ท่านวางบรรทัดฐานสำคัญหลายประการที่ส่งอิทธิพลต่อการเมืองไทยไปอีกหลายชั่วอายุคน โดยเฉพาะหลักการที่ว่าอำนาจบริหารต้องรับผิดชอบต่อรัฐสภาที่มาจากการเลือกตั้ง ไม่ใช่ต่อกลุ่มอำนาจใดกลุ่มหนึ่งเป็นการเฉพาะ ซึ่งกลายเป็นรากฐานที่คณะรัฐมนตรีทุกชุดหลังจากนั้นยึดถือปฏิบัติสืบมา</p>
            </div>
          </div>
        </div>
        ...
        <div class="tri-layout" style="margin-bottom: 32px;">
          ...
          <div class="tri-bio">
            <div class="tri-stage">
              <div class="tri-stage-title">📈 นักธุรกิจและผู้ร่างรัฐธรรมนูญฉบับ ๒๔๔๕</div>
              <p class="tri-stage-text">นักธุรกิจโทรคมนาคมผู้ผันตัวมาเป็นนักการเมือง ก่อตั้งพรรคไทยรักไทยและได้รับเลือกเป็นนายกรัฐมนตรีคนที่ ๔ ในยุคเปลี่ยนผ่านจากรัฐธรรมนูญฉบับปฐมเวลามาสู่ยุคใหม่ เขาเป็นผู้ผลักดันหลักในการยกร่างรัฐธรรมนูญฉบับ ๒๔๔๕ (๑๖ หมวด ๔๕๘ มาตรา) วางกรอบโครงสร้างอำนาจนิติบัญญัติ-บริหาร-ตุลาการให้ทันสมัยขึ้น พร้อมแนวนโยบายประชานิยมที่เน้นกระตุ้นเศรษฐกิจฐานราก (กองทุนหมู่บ้าน, หลักประกันสุขภาพถ้วนหน้า, พักหนี้เกษตรกร) ทำให้พรรคของเขาชนะการเลือกตั้งถล่มทลายและครองอำนาจต่อเนื่องหลายสมัย</p>
            </div>

            <div class="tri-stage">
              <div class="tri-stage-title">⚖️ มรดกสองด้านและการตรวจสอบที่เข้มข้นขึ้น</div>
              <p class="tri-stage-text">เขาเป็นที่จดจำสองด้าน — ด้านหนึ่งคือผู้วางรากฐานเศรษฐกิจและกฎหมายที่ทำให้ประเทศก้าวกระโดด อีกด้านคือข้อวิพากษ์วิจารณ์เรื่องการรวมศูนย์อำนาจและผลประโยชน์ทับซ้อนทางธุรกิจ ซึ่งเป็นเหตุผลหนึ่งที่ทำให้รัฐธรรมนูญฉบับ ๒๔๔๕ ถูกแทนที่ด้วยฉบับ ๒๕๒๕ ในเวลาต่อมา (ที่วางกลไกตรวจสอบการใช้อำนาจไว้เข้มงวดกว่าเดิมมาก โดยเฉพาะหมวด ๒๕ ต่อต้านการทุจริต)</p>
            </div>
        ...
        <div class="tri-layout" style="margin-bottom: 32px;">
          ...
          <div class="tri-bio">
            <div class="tri-stage">
              ...
              <p class="tri-stage-text">เกิดในครอบครัวแพทย์ที่มีชื่อเสียง บิดาคือ ศ.นพ.อรรถสิทธิ์ เวชชาชีวะ อดีตรัฐมนตรีช่วยว่าการกระทรวงสาธารณสุข มารดาคือ ศ.พญ.สดใส เวชชาชีวะ อภิสิทธิ์ศึกษาระดับมัธยมศึกษาที่โรงเรียนอีตัน (Eton College) ประเทศอังกฤษ ก่อนเข้าศึกษาต่อระดับปริญญาตรีและปริญญาโทด้านปรัชญา การเมือง และเศรษฐศาสตร์ (PPE) ที่มหาวิทยาลัยออกซ์ฟอร์ด (University of Oxford) เมื่อกลับมาประเทศไทย เขาได้เริ่มทำงานเป็นอาจารย์ประจำโรงเรียนนายร้อยพระจุลจอมเกล้า และต่อมาเป็นอาจารย์ประจำคณะเศรษฐศาสตร์ มหาวิทยาลัยธรรมศาสตร์ ก่อนเข้าสู่การเมืองในนามพรรคประชาธิปัตย์ ด้วยภาพลักษณ์นักวิชาการรุ่นใหม่ที่พูดจาสุภาพ มีระเบียบวินัยสูง และเชี่ยวชาญด้านเศรษฐศาสตร์และการเมือง</p>
            </div>
        ...
        <div class="tri-layout">
          ...
          <div class="tri-bio">
            ...
            <div class="tri-stage">
              ...
              <p class="tri-stage-text">เมื่อนิวัตกลับสู่ปิตุภูมิ เขาได้จัดตั้งพรรคการเมือง in นาม "พรรครณขจัด" (ซึ่งต่อมาได้ปรับปรุงเป็น "พรรคธรรมปัญญา") โดยดำเนินนโยบายสายกลางบนหลักจริยธรรมและการสมานฉันท์เป็นที่ตั้ง เขาประสบความสำเร็จในการรับฟัง เจรจา และใช้กลยุทธ์นิกายสนธิปัญญาเข้าคลี่คลายปัญหาความขัดแย้งรุนแรงในพื้นที่ ๓ จังหวัดชายแดนภาคใต้ของไทยที่เรื้อรังมานานหลายทศวรรษได้สำเร็จเป็นที่ประจักษ์ นำพาเขากลับคืนสู่อำนาจรัฐสภาในฐานะรองนายกรัฐมนตรีผู้เป็นปราชญ์แห่งการปรองดอง</p>
            </div>
