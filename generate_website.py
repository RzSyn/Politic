  ...
  <div class="dashboard-card">
      ...
      <div class="rama7-profile" style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap; text-align: left;">
        ...
        <div style="flex: 0.9; min-width: 300px; background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(212, 175, 55, 0.15); border-radius: 12px; padding: 20px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="king_r7.jpg" alt="พระประชาธิปมหาราช" style="width: 180px; border-radius: 8px; border: 2px solid var(--gold); box-shadow: 0 6px 15px rgba(0,0,0,0.5);">
          </div>
    ...
    <div id="rama9-tab" class="db-tab-content">
      <div class="rama9-profile" style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap; text-align: left;">
        ...
        <div style="flex: 0.9; min-width: 300px; background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(212, 175, 55, 0.15); border-radius: 12px; padding: 20px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="king_r9.webp" alt="พระมหาภูมิพลมหาราช" style="width: 180px; border-radius: 8px; border: 2px solid var(--gold); box-shadow: 0 6px 15px rgba(0,0,0,0.5);">
          </div>
            ...
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 150px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r1.png" alt="พระบาทสมเด็จพระพุทธยอดฟ้าจุฬาโลกมหาราช" style="width: 150px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 10px rgba(0,0,0,0.4);">
                </div>
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 150px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r2.png" alt="พระบาทสมเด็จพระพุทธเลิศหล้านภาลัย" style="width: 150px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 10px rgba(0,0,0,0.4);">
                </div>
                <div style="flex: 1; min-width: 250px;">
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 150px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r3.png" alt="พระบาทสมเด็จพระนั่งเกล้าเจ้าอยู่หัว" style="width: 150px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 10px rgba(0,0,0,0.4);">
                </div>
                <div style="flex: 1; min-width: 250px;">
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 150px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r4.jpg" alt="พระบาทสมเด็จพระจอมเกล้าเจ้าอยู่หัว" style="width: 150px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 10px rgba(0,0,0,0.4);">
                </div>
                <div style="flex: 1; min-width: 250px;">
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 150px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r5.jpg" alt="พระบาทสมเด็จพระจุลจอมเกล้าเจ้าอยู่หัว" style="width: 150px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 10px rgba(0,0,0,0.4);">
                </div>
                <div style="flex: 1; min-width: 250px;">
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 150px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r6.jpg" alt="พระบาทสมเด็จพระมงกุฎเกล้าเจ้าอยู่หัว" style="width: 150px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 10px rgba(0,0,0,0.4);">
                </div>
                <div style="flex: 1; min-width: 250px;">
        ...
        <div class="accordion-item">
          ...
          <div class="accordion-content">
            <div style="padding: 16px; line-height: 1.6; font-size: 14px; color: var(--text);">
              <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap;">
                <div style="flex: 0 0 150px; text-align: center; margin-bottom: 12px;">
                  <img src="king_r7.jpg" alt="พระบาทสมเด็จพระปกเกล้าเจ้าอยู่หัว" style="width: 150px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 10px rgba(0,0,0,0.4);">
                </div>
                <div style="flex: 1; min-width: 250px;">
