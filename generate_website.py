...
pms = [
    ...
    {"num": 20, "name": "พริษฐ์ \"ไอติม\" วัชรสินธุ", "years": "2596-2612", "era": "รัฐธรรมนูญฉบับ พ.ศ. ๒๕๒๕", "era_class": "era-3", "note": "นายกรัฐมนตรีคนที่ ๒๐ ผู้นำสายคนรุ่นใหม่ผู้ผ่านพ้นวิกฤตนิติประหารสภาด้วยการอภิปรายชี้แจงรัฐสภานาน ๑๐ วัน ท่านผลักดันโครงการก่อสร้างคลองไทยไมตรี ๒.๐ เชื่อมสองฝั่งทะเล และร่วมสถาปนากลไกการทูตและองค์กรความมั่นคงพิเศษ GOC เพื่อเสถียรภาพสูงสุดของประเทศ"},
    {"num": 21, "name": "วิสุทธิ์ คมณรัตน์", "years": "2612-2614", "era": "รัฐธรรมนูญฉบับ พ.ศ. ๒๕๒๕", "era_class": "era-3", "note": "นายกรัฐมนตรีคนที่ ๒๑ ผู้พยายามใช้ช่องโหว่ทางกฎหมายเพื่อผลักดันการแก้ไขโครงร่างสัดส่วนรัฐธรรมนูญโดยขัดต่อเจตนารมณ์ร่วมของรัฐสภา ท่านถูกตรวจสอบและควบคุมอำนาจโดยกระบวนการตุลาการ จนศาลรัฐธรรมนูญมีมติเป็นเอกฉันท์ ๖-๐ ให้พ้นจากตำแหน่งหลังดำรงตำแหน่งได้เพียง ๒ ปี"},
...
for pm in pms:
  ...
  <td>
    <div style="display: flex; align-items: center; gap: 12px; min-width: 260px;">
      <img src="{img_filename}" alt="{name_str}" style="width: 42px; height: 42px; border-radius: 50%; object-fit: cover; border: 1.5px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.05); flex-shrink: 0;">
      <span style="color: var(--gold-light); font-size: 14.5px;">{name_display}</span>
    </div>
  </td>
  <td>{years_str}</td>
