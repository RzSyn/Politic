...
<!-- Tab 7: ทำเนียบนายกรัฐมนตรี -->
    ...
    <div id="figures-tab" class="db-tab-content">
      ...
      <div class="tri-container">
        ...
        <div class="tri-layout" style="margin-bottom: 32px;">
          <div class="tri-profile-card">
            <img src="puey.jpg" alt="ดร. ป๋วย อึ๊งภากรณ์" class="tri-profile-img">
            <div class="tri-profile-name">ดร. ป๋วย อึ๊งภากรณ์</div>
            <div class="tri-profile-title">ผู้ว่าการธนาคารแห่งสยามและบิดาแห่งรัฐสวัสดิการ</div>
            <div class="tri-meta">
              <div style="margin-bottom: 6px;"><strong>ตำแหน่งสำคัญ:</strong> ผู้ว่าการธนาคารแห่งสยาม (ยุคพัฒนาเศรษฐกิจ)</div>
              <div style="margin-bottom: 6px;"><strong>รางวัลเกียรติยศ:</strong> รางวัลแมกไซไซ / บุคคลสำคัญของโลก (UNESCO)</div>
              <div style="margin-bottom: 6px;"><strong>แนวคิดหลัก:</strong> เสรีจริยธรรมและระบบการคลังโปร่งใส</div>
              <div><strong>มรดกนโยบาย:</strong> ก่อตั้งระบบสวัสดิการชนบทกระจายรายได้</div>
            </div>
          </div>

          <div class="tri-bio">
            <div class="tri-stage">
              <div class="tri-stage-title">🏛️ ผู้ออกแบบสถาปัตยกรรมการคลังและระบบการเงินสยาม</div>
              <p class="tri-stage-text">ในไทม์ไลน์ของการครองราชย์ที่สงบสุขและไม่มีรัฐประหาร ดร. ป๋วย อึ๊งภากรณ์ ได้รับมอบหมายให้ดำรงตำแหน่งผู้ว่าการธนาคารแห่งสยาม ท่านเป็นสถาปนิกคนสำคัญในการปฏิรูปและวางรากฐานระบบเศรษฐกิจเสรีจริยธรรมของประเทศ โดยสามารถออกแบบระบบงบประมาณแผ่นดินที่โปร่งใส ปกป้องคลังหลวงจากการทุจริตเชิงอำนาจ และรักษาเสถียรภาพค่าเงินบาทให้แข็งแกร่งสูงสุดในยุคที่สยามเริ่มเปิดรับวิทยาการสมัยใหม่</p>
            </div>

            <div class="tri-stage">
              <div class="tri-stage-title">🌾 การขับเคลื่อนระบบสวัสดิการชนบทและการพัฒนาเชิงพื้นที่</div>
              <p class="tri-stage-text">ท่านเชื่อมั่นว่าความมั่งคั่งของเมืองหลวงต้องกระจายออกสู่ชุมชนฐานรากอย่างทั่วถึง ดร. ป๋วยจึงเป็นผู้ริเริ่มจัดตั้งโครงการพัฒนาชนบทและบัณฑิตอาสาสมัคร ส่งเสริมให้ปัญญาชนรุ่นใหม่ลงพื้นที่ชนบทเพื่อช่วยเหลือและยกมาตรฐานคุณภาพชีวิต ระบบสาธารณสุข และการศึกษาให้แก่ประชาชนในพื้นที่ห่างไกล โดยได้รับความร่วมมืออย่างดียิ่งจากฝ่ายสภาผู้แทนราษฎร</p>
            </div>

            <div class="tri-stage">
              <div class="tri-stage-title">📜 ปราชญ์ผู้ซื่อสัตย์สุจริตและสัญลักษณ์แห่งจริยธรรมข้าราชการ</div>
              <p class="tri-stage-text">ดร. ป๋วย ได้รับการจดจำและยกย่องอย่างสูงในประวัติศาสตร์สยามฐานะแบบอย่างของข้าราชการที่มีความซื่อสัตย์สุจริตและยึดมั่นในประชาธิปไตยอย่างเป็นระบบ ท่านได้รับรางวัลแมกไซไซและรับรองโดย UNESCO ให้เป็นบุคคลสำคัญของโลก ความทุ่มเทและหลักคิดเชิงคุณธรรมทางการเงินของท่านกลายเป็นต้นแบบสำคัญที่สถาบันนิติบัญญัติและคณะรัฐมนตรีนำมาอ้างอิงในการร่างกฎหมายการเงินของสยามประเทศจนถึงยุคปัจจุบัน</p>
            </div>
          </div>
        </div>
        ...
        <div class="tri-layout" style="margin-bottom: 32px;">
          <div class="tri-profile-card">
            ...
            <div class="tri-meta">
              ...
              <div style="margin-bottom: 6px;"><strong>ผลงานเด่น:</strong> ผู้ริเริ่มสภาร่างรัฐธรรมนูญ ๓,๐๐0 คน</div>
        ...
        <div class="tri-layout" style="margin-bottom: 32px;">
          <div class="tri-profile-card">
            <img src="seub.jpg" alt="สืบ นาคะเสถียร" class="tri-profile-img">
            <div class="tri-profile-name">สืบ นาคะเสถียร</div>
            <div class="tri-profile-title">ปราชญ์สิ่งแวดล้อมและผู้พิทักษ์มรดกโลกทางธรรมชาติ</div>
            <div class="tri-meta">
              <div style="margin-bottom: 6px;"><strong>ตำแหน่งสำคัญ:</strong> หัวหน้าเขตรักษาพันธุ์สัตว์ป่าห้วยขาแข้ง</div>
              <div style="margin-bottom: 6px;"><strong>ความสำเร็จหลัก:</strong> ผลักดันผืนป่าตะวันตกเป็นมรดกโลก (UNESCO)</div>
              <div style="margin-bottom: 6px;"><strong>แนวคิดหลัก:</strong> นิเวศวิทยาและความหลากหลายทางชีวภาพ</div>
              <div><strong>มรดกผลงาน:</strong> ปกป้องป่าต้นน้ำและสร้างนวัตกรรมอุทยานอัจฉริยะ</div>
            </div>
          </div>

          <div class="tri-bio">
            <div class="tri-stage">
              <div class="tri-stage-title">🌳 การอนุรักษ์ธรรมชาติและการศึกษาทางวิชาการสิ่งแวดล้อม</div>
              <p class="tri-stage-text">ในช่วงเวลาที่ประเทศสยามมีอัตราการพัฒนาเศรษฐกิจและอุตสาหกรรมอย่างก้าวกระโดด สืบ นาคะเสถียร ได้อุทิศตนศึกษาค้นคว้าวิจัยความหลากหลายทางชีวภาพและอุทิศตนเพื่อปกป้องผืนป่าห้วยขาแข้งและทุ่งใหญ่นเรศวร ในไทม์ไลน์การปกครองสิริพัฒน์นี้ ด้วยการประสานงานเชิงวิชาการอย่างเป็นระบบ ท่านได้รับความไว้วางใจจากรัฐสภาสยามให้นำเสนอข้อมูลเชิงลึกทางนิเวศวิทยาเพื่อจัดระเบียบกฎหมายคุ้มครองสัตว์ป่าและพื้นที่อุทยานแห่งชาติ</p>
            </div>

            <div class="tri-stage">
              <div class="tri-stage-title">📜 การสถาปนามรดกโลกทางธรรมชาติแห่งแรกของสยามประเทศ</div>
              <p class="tri-stage-text">ความมุ่งมั่นและความทุ่มเททางการวิจัยส่งผลให้ผลงานเขียนรายงานของท่านได้รับการรับรองอย่างเป็นทางการจากองค์การ UNESCO ประกาศให้เขตรักษาพันธุ์สัตว์ป่าห้วยขาแข้งและทุ่งใหญ่นเรศวรขึ้นทะเบียนเป็น **มรดกโลกทางธรรมชาติแห่งแรกของไทย** ซึ่งเป็นการยกระดับมาตรฐานการอนุรักษ์พื้นที่ป่าไม้ของสยามสู่ระดับโลก และเป็นหลักประกันให้ผืนป่าขนาดใหญ่ไม่ถูกทำลายด้วยความมักง่ายเชิงพาณิชย์</p>
            </div>

            <div class="tri-stage">
              <div class="tri-stage-title">🛡️ ความสำเร็จของการพิทักษ์ป่าและรัฐประชาธิปไตยสิ่งแวดล้อม</div>
              <p class="tri-stage-text">ในประวัติศาสตร์ที่รัฐบาลและรัฐสภาไทยทำงานบนพื้นฐานวิทยาศาสตร์และการรับฟังข้อมูลจากภาคประชาชนอย่างโปร่งใส สืบ นาคะเสถียร ประสบความสำเร็จในการทำงานอนุรักษ์โดยไม่ต้องสลับร่างสละชีพตนเอง รัฐสภาได้รับฟังคำคัดค้านและยกเลิกโครงการก่อสร้างเขื่อนน้ำโจนที่จะตัดทำลายป่าต้นน้ำของประเทศ พร้อมอนุมัติงบประมาณสนับสนุนนวัตกรรมการพิทักษ์ป่าอัจฉริยะ (Smart Patrol) ที่ใช้เทคโนโลยีโดรนและการสื่อสารตรวจการเพื่อปกป้องทรัพยากรธรรมชาติเพื่อลูกหลานไทย</p>
            </div>
          </div>
        </div>
